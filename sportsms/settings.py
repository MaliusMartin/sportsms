"""
Django settings for sportsms project.
...
SECRET_KEY = 'django-insecure-sn31po#jjslx+o+s%b(^)&u#p_uxf(wx#jx)xv2^jw$$=u%g-n'
...
WSGI_APPLICATION = 'sportsms.wsgi.application'
